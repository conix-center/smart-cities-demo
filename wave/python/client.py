...
class Client:
    ...
    """
    def __init__(self, entity_name="gabe", wave_uri="localhost:410", mosquitto_url="broker.cal-sdb.org", mosquitto_pass="risecamp2018", mosquitto_user="risecamp2018", on_message=None):
