...
class Client:
    ...
    """
    def __init__(self, entity_name="gabe", wave_uri="localhost:410", mosquitto_url="", mosquitto_pass="", mosquitto_user="", mosquitto_port=1883, moquitto_tls=True, mosquitto_capath=None, on_message=None):
